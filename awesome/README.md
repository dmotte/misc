...
- **Ruffle** - Adobe Flash Player emulator written in Rust. Supports SWF (Small Web Format / Shockwave Flash) files and ActionScript: [example](https://ruffle.rs/demo/) [github](https://github.com/ruffle-rs/ruffle) [website](https://ruffle.rs/)
