...
- **AVNC** - free and open-source VNC client for Android: [fdroid](https://f-droid.org/packages/com.gaurav.avnc/) [github](https://github.com/gujjwal00/avnc)
...
- **Chubby Click** - FOSS metronome with the gigging musician in mind: [codeberg](https://codeberg.org/agrigolo/chubby-click) [fdroid](https://f-droid.org/packages/agrigolo.chubbyclick/)
- **CoMaps** - community-led, free and open source maps app based on OpenStreetMap data and reinforced with commitment to transparency, privacy and being not-for-profit: [codeberg](https://codeberg.org/comaps/comaps) [fdroid](https://f-droid.org/packages/app.comaps.fdroid/) [playstore](https://play.google.com/store/apps/details?id=app.comaps.google) [website](https://www.comaps.app/)
...
- **RSAF** - Android document provider for rclone, that allows any app that supports SAF (Storage Access Framework) to access rclone backends: [fdroid](https://f-droid.org/packages/com.chiller3.rsaf/) [github](https://github.com/chenxiaolong/RSAF)
...
- **StreetComplete** - easy to use OpenStreetMap editor: [fdroid](https://f-droid.org/packages/de.westnordost.streetcomplete/) [github](https://github.com/streetcomplete/streetcomplete) [playstore](https://play.google.com/store/apps/details?id=de.westnordost.streetcomplete) [website](https://streetcomplete.app/)
...
- **Chip Player JS** - web-based music player for a variety of video game and chiptune music formats: [github](https://github.com/mmontag/chip-player-js) [website](https://chiptune.app/)
...
- **OUI.IS** - MAC address OUI (Organizationally Unique Identifier) vendor lookup web utility: [github](https://github.com/thatmattlove/oui-web) [website](https://oui.is/)
...
- **NBD** - Network Block Device, forward a block device (typically a hard disk or partition) over the network: [apt](https://packages.debian.org/stable/nbd-client) [apt](https://packages.debian.org/stable/nbd-server) [docs](https://manpages.debian.org/bookworm/nbd-client/nbd-client.8.en.html) [docs](https://manpages.debian.org/bookworm/nbd-server/nbd-server.1.en.html) [docs](https://manpages.debian.org/bookworm/nbd-server/nbd-server.5.en.html) [github](https://github.com/NetworkBlockDevice/nbd) [tutorial](https://github.com/NetworkBlockDevice/nbd?tab=readme-ov-file#using-nbd) [tutorial](https://medium.com/@aysadx/linux-nbd-introduction-to-linux-network-block-devices-143365f1901b) [wikipedia](https://en.wikipedia.org/wiki/Network_block_device)
...
- **Syncthing** - open-source continuous file synchronization program: [apt](https://packages.debian.org/stable/syncthing) [choco](https://community.chocolatey.org/packages/syncthing) [docker](https://hub.docker.com/r/syncthing/syncthing) [github](https://github.com/syncthing/syncthing) [playstore](https://play.google.com/store/apps/details?id=com.github.catfriend1.syncthingandroid) [website](https://syncthing.net/)
...
- **Xvfb** - virtual framebuffer X server: [apt](https://packages.debian.org/stable/xvfb) [docs](https://linux.die.net/man/1/xvfb)
...
- **auditd** - track security-related information on your Linux system, based on preconfigured rules and properties: [apt](https://packages.debian.org/stable/auditd) [guide](https://www.redhat.com/sysadmin/configure-linux-auditing-auditd)
...
- **rsyslog** - rocket-fast system for log processing: [apt](https://packages.debian.org/stable/rsyslog) [github](https://github.com/rsyslog/rsyslog) [website](https://www.rsyslog.com/)
...
- **x11vnc** - VNC server for real X displays: [apt](https://packages.debian.org/stable/x11vnc) [docs](https://linux.die.net/man/1/x11vnc) [github](https://github.com/LibVNC/x11vnc)
- **xrdp** - open-source Remote Desktop Protocol server: [apt](https://packages.debian.org/stable/xrdp) [github](https://github.com/neutrinolabs/xrdp) [website](https://www.xrdp.org/)
...
- **Glances** - cross-platform system monitoring tool written in Python: [apt](https://packages.debian.org/stable/glances) [github](https://github.com/nicolargo/glances) [pypi](https://pypi.org/project/Glances/) [website](https://nicolargo.github.io/glances/)
- **PRoot** - chroot, mount --bind, and binfmt_misc without privilege/setup. Rootless fake root wrapper rootfs, also works in Termux: [apt](https://packages.debian.org/stable/proot) [docs](https://wiki.termux.com/wiki/PRoot) [github](https://github.com/proot-me/proot) [website](https://proot-me.github.io/)
- **Podman** - tool for managing OCI containers and pods, similar to Docker but rootless and daemonless: [apt](https://packages.debian.org/stable/podman) [github](https://github.com/containers/podman) [website](https://podman.io/)
- **Termshark** - terminal TUI for tshark, inspired by Wireshark: [apt](https://packages.debian.org/stable/termshark) [github](https://github.com/gcla/termshark) [website](https://termshark.io/)
...
- **bat** - cat with syntax highlighting and git integration: [apt](https://packages.debian.org/stable/bat) [choco](https://community.chocolatey.org/packages/Bat) [github](https://github.com/sharkdp/bat)
...
- **git-remote-gcrypt** - git remote helper to push and pull from repositories PGP-encrypted with GnuPG, using a custom format: [apt](https://packages.debian.org/stable/git-remote-gcrypt) [github](https://github.com/spwhitton/git-remote-gcrypt) [website](https://spwhitton.name/tech/code/git-remote-gcrypt/)
- **hexedit** - viewer and editor in hexadecimal or ASCII for files or devices: [apt](https://packages.debian.org/stable/hexedit) [docs](https://rigaux.org/hexedit.html) [github](https://github.com/pixel/hexedit)
- **htop** - ncurses-based process viewer similar to top: [apt](https://packages.debian.org/stable/htop) [github](https://github.com/htop-dev/htop) [website](https://htop.dev/)
- **ipcalc** - calculate broadcast, network and range from an IPv4 address or CIDR notation: [apt](https://packages.debian.org/stable/ipcalc) [github](https://github.com/kjokjo/ipcalc) [website](https://jodies.de/ipcalc)
- **lnav** - log files navigator TUI: [apt](https://packages.debian.org/stable/lnav) [github](https://github.com/tstack/lnav) [website](https://lnav.org/)
- **lynx** - classic non-graphical (text-mode / TUI) web browser: [apt](https://packages.debian.org/stable/lynx) [website](https://lynx.invisible-island.net/)
- **ncdu** - ncurses TUI disk usage analyzer: [apt](https://packages.debian.org/stable/ncdu) [website](https://dev.yorhel.nl/ncdu)
- **qrencode** - QR code encoder to PNG image: [apt](https://packages.debian.org/stable/qrencode) [github](https://github.com/fukuchi/libqrencode) [website](https://fukuchi.org/works/qrencode/index.html.en)
- **speedometer** - monitor and display the rate of data (speed) across a network connection: [apt](https://packages.debian.org/stable/speedometer) [github](https://github.com/wardi/speedometer) [website](https://excess.org/speedometer/)
- **speedtest-cli** - CLI for testing internet bandwidth using speedtest.net: [apt](https://packages.debian.org/stable/speedtest-cli) [github](https://github.com/sivel/speedtest-cli) [pypi](https://pypi.org/project/speedtest-cli/)
- **strings** - print the strings of printable characters in files: [docs](https://linux.die.net/man/1/strings)
- **sysstat** - utilities to monitor system performance and usage activity (i.e. iostat, mpstat, pidstat): [apt](https://packages.debian.org/stable/sysstat) [github](https://github.com/sysstat/sysstat) [website](https://sysstat.github.io/)
- **tcpdump** - command-line packet analyzer for network traffic capture: [apt](https://packages.debian.org/stable/tcpdump) [docs](https://www.tcpdump.org/manpages/tcpdump.1.html) [github](https://github.com/the-tcpdump-group/tcpdump) [tutorial](https://opensource.com/article/18/10/introduction-tcpdump) [website](https://www.tcpdump.org/)
- **tmux** - terminal multiplexer, similar to GNU Screen: [apt](https://packages.debian.org/stable/tmux) [github](https://github.com/tmux/tmux)
- **tree** - recursive directory listing CLI tool that displays a depth indented directory tree: [apt](https://packages.debian.org/stable/tree)
- **wavemon** - Wi-Fi wireless device monitoring application that allows you to watch signal and noise levels, packet statistics, device configuration and network parameters of your wireless network hardware: [apt](https://packages.debian.org/stable/wavemon) [github](https://github.com/uoaerg/wavemon)
- **xdotool** - CLI command line automation for X11 that lets you simulate (generate) X11 keyboard/mouse input events: [apt](https://packages.debian.org/stable/xdotool) [github](https://github.com/jordansissel/xdotool) [youtube](https://www.youtube.com/watch?v=1DF58wDDfBE)
...
- **Minify** - minifier package written in Go: [apt](https://packages.debian.org/stable/minify) [choco](https://community.chocolatey.org/packages/minify) [github](https://github.com/tdewolff/minify) [website](https://go.tacodewolff.nl/minify)
- **MkDocs** - Markdown to HTML static site generator for project documentation, written in Python: [apt](https://packages.debian.org/stable/mkdocs) [choco](https://community.chocolatey.org/packages/mkdocs) [github](https://github.com/mkdocs/mkdocs) [pypi](https://pypi.org/project/mkdocs/) [website](https://www.mkdocs.org/)
- **Ngspice** - open source SPICE simulator for electric and electronic circuits: [apt](https://packages.debian.org/stable/ngspice) [choco](https://community.chocolatey.org/packages/ngspice) [sourceforge](https://sourceforge.net/projects/ngspice/) [website](https://ngspice.sourceforge.io/)
- **Nmap** - utility for network exploration or security auditing, supports ping and port scanning: [apt](https://packages.debian.org/stable/nmap) [choco](https://community.chocolatey.org/packages/nmap)
...
- **QPDF** - content-preserving PDF document transformer: [apt](https://packages.debian.org/stable/qpdf) [choco](https://community.chocolatey.org/packages/qpdf) [github](https://github.com/qpdf/qpdf) [website](https://qpdf.sourceforge.io/)
- **Rclone** - sync files from/to cloud storage, like rsync but for cloud: [apt](https://packages.debian.org/stable/rclone) [choco](https://community.chocolatey.org/packages/rclone) [docker](https://hub.docker.com/r/rclone/rclone) [github](https://github.com/rclone/rclone) [website](https://rclone.org/)
- **Restic** - modern backup program: [apt](https://packages.debian.org/stable/restic) [choco](https://community.chocolatey.org/packages/restic) [docker](https://hub.docker.com/r/restic/restic) [github](https://github.com/restic/restic) [website](https://restic.net/)
- **ShellCheck** - Bash shell script checker: [apt](https://packages.debian.org/stable/shellcheck) [choco](https://community.chocolatey.org/packages/shellcheck) [github](https://github.com/koalaman/shellcheck) [website](https://www.shellcheck.net/)
- **Tesseract** - open source OCR (Optical Character Recognition) engine: [apt](https://packages.debian.org/stable/tesseract-ocr) [choco](https://community.chocolatey.org/packages/tesseract) [github](https://github.com/tesseract-ocr/tesseract) [website](https://tesseract-ocr.github.io/)
- **Tig** - ncurses-based text-mode interface for Git: [apt](https://packages.debian.org/stable/tig) [choco](https://community.chocolatey.org/packages/git) [github](https://github.com/jonas/tig) [website](https://jonas.github.io/tig/)
- **Vagrant** - create and configure lightweight, reproducible, and portable virtual environments (e.g. VirtualBox virtual machines): [apt](https://packages.debian.org/stable/vagrant) [choco](https://community.chocolatey.org/packages/vagrant) [github](https://github.com/hashicorp/vagrant) [website](https://www.vagrantup.com/)
...
- **mc** - Midnight Commander terminal-based TUI file manager: [apt](https://packages.debian.org/stable/mc) [choco](https://community.chocolatey.org/packages/mc) [github](https://github.com/MidnightCommander/mc) [website](https://midnight-commander.org/)
- **mpremote** - MicroPython remote control, an integrated set of utilities to remotely interact with and automate a MicroPython device over a serial connection: [apt](https://packages.debian.org/stable/micropython-mpremote) [pypi](https://pypi.org/project/mpremote/) [website](https://docs.micropython.org/en/latest/reference/mpremote.html)
- **pipx** - install and run Python applications in isolated environments, similar to JavaScript's npx: [apt](https://packages.debian.org/stable/pipx) [github](https://github.com/pypa/pipx) [pypi](https://pypi.org/project/pipx/) [website](https://pipx.pypa.io/stable/)
...
- **Fritzing** - electronic design automation software: [apt](https://packages.debian.org/stable/fritzing) [choco](https://community.chocolatey.org/packages/fritzing) [website](https://fritzing.org/)
- **GIMP** - multi-platform photo manipulation tool: [apt](https://packages.debian.org/stable/gimp) [choco](https://community.chocolatey.org/packages/gimp) [website](https://www.gimp.org/)
- **GNU Octave** - high-level language primarily intended for numerical computations, similar to MATLAB: [apt](https://packages.debian.org/stable/octave) [choco](https://community.chocolatey.org/packages/Octave) [website](https://octave.org/)
- **GeoGebra** - dynamic mathematics software: [apt](https://packages.debian.org/stable/geogebra) [choco](https://community.chocolatey.org/packages/geogebra-classic.install) [webapp](https://www.geogebra.org/classic) [website](https://www.geogebra.org/)
...
- **HandBrake** - tool for converting video from nearly any format to a selection of modern, widely supported codecs: [apt](https://packages.debian.org/stable/handbrake) [choco](https://community.chocolatey.org/packages/handbrake) [github](https://github.com/HandBrake/HandBrake) [website](https://handbrake.fr/)
- **Inkscape** - open-source vector graphics editor: [apt](https://packages.debian.org/stable/inkscape) [choco](https://community.chocolatey.org/packages/inkscape) [gitlab](https://gitlab.com/inkscape/inkscape) [website](https://inkscape.org/)
- **Kdenlive** - KDE Non-Linear Video Editor: [apt](https://packages.debian.org/stable/kdenlive) [choco](https://community.chocolatey.org/packages/Kdenlive) [website](https://kdenlive.org/)
- **KeePassXC** - free open source password manager: [apt](https://packages.debian.org/stable/keepassxc) [choco](https://community.chocolatey.org/packages/keepassxc) [github](https://github.com/keepassxreboot/keepassxc) [website](https://keepassxc.org/)
- **KiCad** - cross-platform open-source PCB and circuit design suite: [apt](https://packages.debian.org/stable/kicad) [choco](https://community.chocolatey.org/packages/kicad) [gitlab](https://gitlab.com/kicad) [website](https://www.kicad.org/)
- **Kid3** - cross-platform audio tag editor for many audio file formats: [apt](https://packages.debian.org/stable/kid3) [choco](https://community.chocolatey.org/packages/kid3) [website](https://kid3.kde.org/)
- **LazPaint** - free cross-platform image and photo editor with raster and vector layers. It can also edit ICO (icon) and CUR (cursor) files: [apt](https://packages.debian.org/stable/lazpaint-qt5) [choco](https://community.chocolatey.org/packages/lazpaint) [github](https://github.com/bgrabitmap/lazpaint) [website](https://lazpaint.github.io/)
- **LibreOffice** - free and open-source office suite: [apt](https://packages.debian.org/stable/libreoffice) [choco](https://community.chocolatey.org/packages/libreoffice-fresh) [website](https://www.libreoffice.org/)
...
- **Minetest** - open source voxel game engine, similar to Minecraft: [apt](https://packages.debian.org/stable/minetest) [choco](https://community.chocolatey.org/packages/minetest) [github](https://github.com/luanti-org/luanti) [website](https://www.luanti.org/)
- **OBS Studio** - Open Broadcaster Software, a free open-source cross-platform screencasting, screen recording, and streaming app: [apt](https://packages.debian.org/stable/obs-studio) [choco](https://community.chocolatey.org/packages/obs-studio) [github](https://github.com/obsproject/obs-studio) [website](https://obsproject.com/)
...
- **Raspberry Pi Imager** - quick and easy way to install Raspberry Pi OS and other operating systems to a microSD card: [choco](https://community.chocolatey.org/packages/rpi-imager) [github](https://github.com/raspberrypi/rpi-imager) [website](https://www.raspberrypi.com/software/)
- **Restic Browser** - visual GUI to browse and restore restic backup repositories: [github](https://github.com/emuell/restic-browser)
- **Ruffle** - Adobe Flash Player emulator written in Rust. Supports SWF (Small Web Format / Shockwave Flash) files and ActionScript: [github](https://github.com/ruffle-rs/ruffle) [webapp](https://ruffle.rs/demo/) [website](https://ruffle.rs/)
...
- **Thunderbird** - free email application: [apt](https://packages.debian.org/stable/thunderbird) [choco](https://community.chocolatey.org/packages/thunderbird) [website](https://www.thunderbird.net/en-US/)
...
- **Tor Browser** - free and open source app to browse the web via Tor: [playstore](https://play.google.com/store/apps/details?id=org.torproject.torbrowser) [website](https://www.torproject.org/)
- **TuxGuitar** - free and open source multitrack tablature editor: [choco](https://community.chocolatey.org/packages/tuxguitar)
- **VLC media player** - free and open source cross-platform multimedia player and framework that plays most multimedia files: [apt](https://packages.debian.org/stable/vlc) [choco](https://community.chocolatey.org/packages/vlc) [website](https://www.videolan.org/vlc/)
- **Ventoy** - open source tool to create a bootable USB drive with multiple ISO/WIM/IMG/VHD(x)/EFI files: [docs](https://www.ventoy.net/en/doc_start.html) [github](https://github.com/ventoy/Ventoy) [website](https://www.ventoy.net/en/index.html) [youtube](https://www.youtube.com/watch?v=-7APoZzNPyU)
...
- **ChordPro** - simple text format for the notation of lyrics with chords: [docs](https://www.chordpro.org/chordpro/chordpro-cheat_sheet/) [github](https://github.com/ChordPro/chordpro) [website](https://www.chordpro.org/) [wikipedia](https://en.wikipedia.org/wiki/ChordPro)
...
- **Plus Codes / OLC (Open Location Code)** - geocode based on a system of regular grids for identifying an area anywhere on the Earth, developed by Google: [website](https://maps.google.com/pluscodes/) [website](https://plus.codes/map) [wikipedia](https://en.wikipedia.org/wiki/Open_Location_Code)
...
- **R3gm Audio Separator** - split an audio file into vocals and background music: [github](https://github.com/R3gm/Audio_separator_ui) [spaces](https://huggingface.co/spaces/r3gm/Audio_separator)
