...
- **Inkscape** - open-source vector graphics editor: [apt](https://packages.debian.org/bookworm/inkscape) [choco](https://community.chocolatey.org/packages/inkscape) [gitlab](https://gitlab.com/inkscape/inkscape) [website](https://inkscape.org/)
...
- **LazPaint** - free cross-platform image and photo editor with raster and vector layers. It can also edit ICO (icon) and CUR (cursor) files: [apt](https://packages.debian.org/bookworm/lazpaint-qt5) [choco](https://community.chocolatey.org/packages/lazpaint) [github](https://github.com/bgrabitmap/lazpaint) [website](https://lazpaint.github.io/)
