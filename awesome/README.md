...
- **Raspberry Pi Imager** - quick and easy way to install Raspberry Pi OS and other operating systems to a microSD card: [choco](https://community.chocolatey.org/packages/rpi-imager) [website](https://www.raspberrypi.com/software/)
