...
curl -fsSLo /etc/systemd/system/raspi-safe-shutdown.service \
    https://raw.githubusercontent.com/dmotte/misc/main/python-scripts/raspi-safe-shutdown/raspi-safe-shutdown.service
...
curl -fsSLo /opt/raspi-safe-shutdown.py \
    https://raw.githubusercontent.com/dmotte/misc/main/python-scripts/raspi-safe-shutdown/raspi-safe-shutdown.py
