...
- `free -htvw`
- `du -sh`
- `cat /etc/os-release | od -An -vtx1z`
...
- `hdparm -I /dev/sdb`, `hdparm --user-master u --security-set-pass p /dev/sdb`, `hdparm --user-master u --security-erase p /dev/sdb`, `hdparm --user-master u --security-erase-enhanced p /dev/sdb`, `blkdiscard /dev/sdb`
