...
- `printf '%s\n' '[mygdrive]' 'type = drive' 'client_id = ' 'client_secret = ' 'scope = drive' 'root_folder_id = ...' > ~/.config/rclone/rclone.conf` (see https://rclone.org/drive/#making-your-own-client-id), `rclone config reconnect mygdrive:`
